...
public class RegEx {
	...
	//주소 확인 일단 너무길어서 틀만 만듬
	public static boolean chckAddress(String user_address){
		String pattString = "(^[가-힣0-9]*)";
		return Pattern.matches(pattString, user_address);
	}
	
	//생일 형식이 올바른지 확인
	public static boolean chckBirthday(String user_birthday){{
		String pattUBirthday = "([0-9]{2}(0[1-9]|1[0-2])(0[1-9]|[1,2][0-9]|3[0,1]))";
		return Pattern.matches(pattUBirthday, user_birthday);
	}
